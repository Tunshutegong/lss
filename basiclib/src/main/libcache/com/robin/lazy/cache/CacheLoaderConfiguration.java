...
public class CacheLoaderConfiguration {
	...
	public CacheLoaderConfiguration(Context context,
									...
									int diskCacheFileCount, MemoryCache memoryCache, long maxAge,  IDiskCacheUtils mIDiskCacheUtils) {
		this(context, diskCacheFileNameGenerator, diskCacheSize,
				diskCacheFileCount, memoryCache, mIDiskCacheUtils);
		this.maxAge = maxAge;
	}
	...
	public CacheLoaderConfiguration(Context context,
									FileNameGenerator diskCacheFileNameGenerator, long diskCacheSize,
									int diskCacheFileCount, MemoryCache memoryCache, IDiskCacheUtils mIDiskCacheUtils) {
