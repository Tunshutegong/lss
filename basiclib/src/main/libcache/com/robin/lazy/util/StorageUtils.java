...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            AbLazyLogger.w("Can't define system cache directory! '%s' will be used.", cacheDirPath);
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                AbLazyLogger.w("Unable to create external cache directory");
                return null;
            }
            try {
                new File(appCacheDir, ".nomedia").createNewFile();
            } catch (IOException e) {
                AbLazyLogger.i("Can't create \".nomedia\" file in application external cache directory");
            }
        }
        return appCacheDir;
    }
