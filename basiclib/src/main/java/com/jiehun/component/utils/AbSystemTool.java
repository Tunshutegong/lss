...
public final class AbSystemTool {
    private static final String TAG = "AbSystemTool";
    ...
    public static void sendSMS(String smsBody) {
        ...
        BaseLibConfig.getContext().startActivity(intent);
    }
    ...
    public static boolean checkNet() {
        ConnectivityManager cm = (ConnectivityManager) BaseLibConfig.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getAppVersion() {
        String version = "0";
        try {
            version = BaseLibConfig.getContext().getPackageManager().getPackageInfo(BaseLibConfig.getContext().getPackageName(), 0).versionName;
    ...
    public static String getPacakgeName() {
        return BaseLibConfig.getContext().getPackageName();
    }
    ...
    public static String getSign(Context context, String pkgName) {
        try {
            ...
            throw new RuntimeException(AbSystemTool.class.getName() + "the " + pkgName + "'s application not found");
        }
    }
    ...
    public static int gc(Context cxt) {
        ...
        Log.e(TAG, "清理了" + (getDeviceUsableMemory(cxt) - i) + "M内存");
        return count;
    }
}