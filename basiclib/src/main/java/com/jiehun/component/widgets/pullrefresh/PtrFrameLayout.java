...
import com.jiehun.component.widgets.pullrefresh.loadmore.DefaultLoadMoreViewFooter;
import com.jiehun.component.widgets.pullrefresh.loadmore.GridViewHandler;
import com.jiehun.component.widgets.pullrefresh.loadmore.ILoadMoreViewFactory;
import com.jiehun.component.widgets.pullrefresh.loadmore.ListViewHandler;
import com.jiehun.component.widgets.pullrefresh.loadmore.LoadMoreHandler;
import com.jiehun.component.widgets.pullrefresh.loadmore.OnLoadMoreListener;
import com.jiehun.component.widgets.pullrefresh.loadmore.OnScrollBottomListener;
import com.jiehun.component.widgets.pullrefresh.loadmore.RecyclerViewHandler;
import com.jiehun.component.widgets.pullrefresh.utils.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private int ptr_max_pull_position = 0;
    ...
    /**
     * 最大可拉的高度
     * @param ptr_max_pull_position
     */
    public void setPtr_max_pull_position(int ptr_max_pull_position) {
        this.ptr_max_pull_position = ptr_max_pull_position;
    }
    ...
    private void movePos(float deltaY) {
        ...
        if(ptr_max_pull_position > 0){
            if((to < (mHeaderHeight) + ptr_max_pull_position + 1)) {
                // over top
    ...
    private void tryScrollBackToTop() {
        if (!mPtrIndicator.isUnderTouch()) {
            ...
            //if has header
            Log.e("hahass:", "header height = " +  getHeaderHeight());
        }
    }
    ...
    public boolean hasInitLoadMoreView(){
        return hasInitLoadMoreView;
    }
