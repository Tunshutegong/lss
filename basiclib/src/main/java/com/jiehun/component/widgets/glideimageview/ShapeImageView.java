...
public class ShapeImageView extends AppCompatImageView {
    ...
    public void setBorderWidth(int borderWidth) {
        if (mBorderWidth != borderWidth) {
            mBorderWidth = AbDisplayUtil.dip2px(borderWidth);
            invalidate();
        }
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        if (mCornerRadius != cornerRadius) {
            mCornerRadius = AbDisplayUtil.dip2px(cornerRadius);
            if (!mIsCircle) {
                invalidate();
            }
        }
    ...
    public void setPressedBorderWidth(int selectedBorderWidth) {
        if (mPressedBorderWidth != selectedBorderWidth) {
            mPressedBorderWidth = AbDisplayUtil.dip2px(selectedBorderWidth);
            if (mIsPressed) {
                invalidate();
            }
        }
