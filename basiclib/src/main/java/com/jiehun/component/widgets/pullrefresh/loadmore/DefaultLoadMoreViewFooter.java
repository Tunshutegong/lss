...
public class DefaultLoadMoreViewFooter implements ILoadMoreViewFactory {
    ...
    private class LoadMoreHelper implements ILoadMoreView {
        ...
        public void init(FootViewAdder footViewHolder, OnClickListener onClickRefreshListener) {
            footerView = footViewHolder.addFootView(R.layout.load_more_default_footer);
            footerTv = (TextView) footerView.findViewById(R.id.load_more_default_footer_tv);
            footerBar = (ProgressBar) footerView.findViewById(R.id.load_more_default_footer_progressbar);
